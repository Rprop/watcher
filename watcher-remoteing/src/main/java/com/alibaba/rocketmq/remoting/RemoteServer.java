...
public interface RemoteServer extends RemoteService {
    ...
    public RemoteCommand invokeSync(final Channel channel, final RemoteCommand request,
            final long timeoutMillis) throws InterruptedException, RemoteSendRequestException,
            RemoteTimeoutException;


    public void invokeAsync(final Channel channel, final RemoteCommand request, final long timeoutMillis,
            final InvokeCallback invokeCallback) throws InterruptedException,
            RemoteTooMuchRequestException, RemoteTimeoutException, RemoteSendRequestException;


    public void invokeOneway(final Channel channel, final RemoteCommand request, final long timeoutMillis)
