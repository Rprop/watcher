...
public class RemoteCommand {
    public static String RemoteVersionKey = "rocketmq.remoting.version";
    ...
    public static RemoteCommand createRequestCommand(int code, CommandCustomHeader customHeader) {
    ...
    public static RemoteCommand createResponseCommand(Class<? extends CommandCustomHeader> classHeader) {
        RemoteCommand cmd =
                createResponseCommand(RemoteSysResponseCode.SYSTEM_ERROR, "not set any response code",
                        classHeader);
    ...
    private static void setCmdVersion(RemoteCommand cmd) {
        if (ConfigVersion >= 0) {
            cmd.setVersion(ConfigVersion);
        } else {
            String v = System.getProperty(RemoteVersionKey);
            if (v != null) {
                    ...
                    if (!fieldName.startsWith("this")) {
                        try {
                            ...
                            if (null == value) {
                                ...
                                if (annotation != null) {
                                    throw new RemoteCommandException("the custom field <" + fieldName
                                            + "> is null");
                                }
...
//    }
    ...
    public static RemoteCommand decode(final ByteBuffer byteBuffer) {
        ...
        RemoteCommand cmd = RemotingSerializable.decode(headerData, RemoteCommand.class);
        cmd.body = bodyData;
    ...
    public com.alibaba.rocketmq.remoting.protocol.LanguageCode getLanguage() {
        return language;
    }


    public void setLanguage(com.alibaba.rocketmq.remoting.protocol.LanguageCode language) {
