...
public class RemoteHelper {
     ...
     * 短连接调用 TODO
     */
    public static RemoteCommand invokeSync(final String addr, final RemoteCommand request,
            final long timeoutMillis) throws InterruptedException, RemoteConnectException,
        ...
        if (socketChannel != null) {
            ...
            try {
                ...
                // 对应答数据解码
                byteBufferBody.flip();
                return RemoteCommand.decode(byteBufferBody);
            }
            catch (IOException e) {
                e.printStackTrace();
