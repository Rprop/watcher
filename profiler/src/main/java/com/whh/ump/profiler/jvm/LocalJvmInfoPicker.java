package com.whh.ump.profiler.jvm;
...
//		}
    ...
    public String pickJvmRumtimeInfo() {
        ...
        sb.append(QUOTATION).append("FGCD").append(QUOTATION).append(COLON).append(QUOTATION).append(getFullGCDuration()).append(QUOTATION).append(COMMA);
        sb.append(QUOTATION).append("YGCD").append(QUOTATION).append(COLON).append(QUOTATION).append(getYoungGCDuration()).append(QUOTATION).append(COMMA);
