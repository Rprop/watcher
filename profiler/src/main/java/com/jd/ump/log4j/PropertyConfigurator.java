 ...
 * com.jd.ump.log4j.xml.DOMConfigurator DOMConfigurator} such as
 * support custom {@link com.jd.ump.log4j.spi.ErrorHandler ErrorHandlers},
 * nested appenders such as the {@link com.jd.ump.log4j.AsyncAppender
 * AsyncAppender}, etc.
 * <p/>
...
public class PropertyConfigurator implements Configurator {
    ...
    /**
     * Key for specifying the {@link com.jd.ump.log4j.spi.LoggerFactory
     ...
     * specifying an {@link com.jd.ump.log4j.or.ObjectRenderer ObjectRenderer}
     ...
     * converted to String before being logged. This is done by
     * specifying an {@link com.jd.ump.log4j.spi.ThrowableRenderer ThrowableRenderer}.
     * <p/>
     * <p>The syntax is:
     * <p/>
     * <pre>
     ...
     * {@link com.jd.ump.log4j.spi.LoggerFactory LoggerFactory}
  ...
  */
                ...
                if (hierarchy instanceof ThrowableRendererSupport) {
                    ThrowableRenderer tr = (ThrowableRenderer)
                            OptionConverter.instantiateByKey(props,
                                    ...
                                    com.jd.ump.log4j.spi.ThrowableRenderer.class,
                                    null);
                    if (tr == null) {
                        LogLog.error(
    ...
    Appender parseAppender(Properties props, String appenderName) {
        ...
        appender = (Appender) OptionConverter.instantiateByKey(props, prefix,
                com.jd.ump.log4j.Appender.class,
                null);
        if (appender == null) {
            LogLog.error(
