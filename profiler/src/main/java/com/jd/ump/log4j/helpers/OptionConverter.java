...
public class OptionConverter {
     ...
     * character is present, then the default {@link com.jd.ump.log4j.Level}
     ...
     *                  {@link com.jd.ump.log4j.xml.DOMConfigurator} is used.
     * @param hierarchy The {@link com.jd.ump.log4j.Hierarchy} to act on.
     * @since 1.1.4
     */
    ...
    public void selectAndConfigure(URL url, String clazz, LoggerRepository hierarchy) {
        ...
        if (clazz == null && filename != null && filename.endsWith(".xml")) {
            clazz = "com.jd.ump.log4j.xml.DOMConfigurator";
        }
