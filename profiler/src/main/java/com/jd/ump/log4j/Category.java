...
public class Category implements AppenderAttachable {
     ...
     * 缓存日志消息
     */
    private MessagesStore msgStore = null;
    ...
    protected Category(String name) {
        ...
        // root不需要缓存日志
        if (!"root".equals(name)) {
            msgStore = new MessagesStore(this);
        }
    }
     ...
     * {@link com.jd.ump.log4j.or.ObjectRenderer}. It then proceeds to call all the
     ...
     * com.jd.ump.log4j.or.ObjectRenderer}. It proceeds to call all the
     * registered appenders in this category and also higher in the
     * hierarchy depending on the value of the additivity flag.
     * <p/>
     * <p><b>WARNING</b> Note that passing a {@link Throwable} to this
     ...
     * {@link com.jd.ump.log4j.or.ObjectRenderer}. It
     ...
     * default hierachy.
     * <p/>
     * <p>Some appenders such as {@link com.jd.ump.log4j.net.SocketAppender}
