...
import com.jd.ump.log4j.pattern.BridgePatternConverter;
...
public class EnhancedPatternLayout extends Layout {
     ...
     * {@link com.jd.ump.log4j.spi.LoggerRepository LoggerRepository} object store.
     */
     ...
     * @since 0.9.0
     */
    protected com.jd.ump.log4j.helpers.PatternParser createPatternParser(String pattern) {
        return new com.jd.ump.log4j.pattern.BridgePatternParser(pattern);
    }
